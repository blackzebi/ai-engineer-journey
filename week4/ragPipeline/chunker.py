...
# Chiến lược tuần này: cắt theo KÝ TỰ có overlap (đơn giản nhất, đủ dùng).
# Tuần 6 sẽ thử cắt theo heading markdown / theo câu và so kết quả.
...
def chunk_text(
    ...
    #
    # Nâng cao (làm nếu còn thời gian): cắt ưu tiên ở ranh giới đoạn ("\\n\\n") thay vì giữa từ,
